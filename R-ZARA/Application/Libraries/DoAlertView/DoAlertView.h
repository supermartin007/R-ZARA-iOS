...
// my color
#define DO_TITLE_BOX                DO_RGB(205, 136, 33)
#define DO_NORMAL_BOX               DO_RGB(255, 255, 255)
#define DO_BUTTON_BOX               DO_RGB(205, 136, 33)
//#define DO_BUTTON_BOX               DO_RGB(61, 155, 196)
#define DO_DESTRUCTIVE_BOX          DO_RGB(0, 0, 250)
#define DO_TEXT_COLOR               DO_RGB(21, 33, 43)
#define DO_DESTRUCTIVE_TEXT_COLOR   DO_RGB(250, 0, 0)
#define DO_DIMMED_COLOR             DO_RGBA(0, 0, 0, 0.6)


#define DO_TEXT_FONT [UIFont fontWithName:@"Aller" size:14]
#define DO_BOLD_FONT [UIFont fontWithName:@"Aller-Bold" size:14]
