...
- (void)showAlertView
{
    ...
    if (_doNo != nil)
    {
        ...
        btNo.frame = CGRectMake(0, dHeight, _vAlert.frame.size.width / 2.0, 40);
        btNo.backgroundColor = DO_BUTTON_BOX;
        btNo.tag = DO_NO_TAG;
        [btNo setImage:[UIImage imageNamed:@"close_black"] forState:UIControlStateNormal];
    ...
    if (_doYes != nil)
    {
        ...
        if (_doNo == nil)
            ...
            btYes.frame = CGRectMake(_vAlert.frame.size.width / 2.0 + 1, dHeight, _vAlert.frame.size.width / 2.0 - 1, 40);

        btYes.backgroundColor = DO_BUTTON_BOX;
        btYes.tag = DO_YES_TAG;
        [btYes setImage:[UIImage imageNamed:@"check_black"] forState:UIControlStateNormal];
